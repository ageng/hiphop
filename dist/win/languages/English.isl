...
; *** Common wizard text
ClickNext=Click Install HipHop to continue, or Cancel to exit Setup.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=You're about to get some HipHop!
WelcomeLabel2=This will install [name/ver] on your computer.%n%nKeep in mind that HipHop is in Beta and we make no guarantees, so use it at your own risk.
